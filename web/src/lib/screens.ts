...
export const HERO: Record<string, Hero> = {
  ...
  "/entrainement/modeles": {
    img: "/assets/flip-turn.jpg", pos: "center 40%", veil: "corner",
    kicker: "Réutilisables", title: "Ta bibliothèque",
    text: "Deux onglets bien séparés : les plans d'entraînement (1 ou plusieurs semaines) et les séances (une seule journée) — chacun garde ses propres modèles, jamais mélangés.",
